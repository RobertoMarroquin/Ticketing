...
function validar(wx){
  ...
  if (wxw%1!==0){
    ...
    tostada("¡No puedes comprar fracciones de boletos!","#f8d7da","#721c24",3000);
  }
  else if(wxw<0){
    wx.value=0;
    tostada("¡No es posible adquirir boletos negativos!","#f8d7da","#721c24",3000);
  }
  else if(boletosTotales>butacasDisponibles){
    wx.value-=(boletosTotales-butacasDisponibles);
    tostada("¡Los boletos no pueden superar la cantidad de butacas disponibles!","#f8d7da","#721c24",3000);
  }
}
